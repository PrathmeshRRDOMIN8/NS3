...
int main(int argc, char *argv[])
{
	...
	outputDevices.Add(nd1.Get(0));	multicast.AddMulticastRoute(multicastRouter,multicastSource,multicastGroup,inputIf,outputDevices);
...
OnOffHelper onoff("ns3::UdpSocketFactory",Address(InetSocketAddress(multicastGroup,multicastPort)));
  ...
  PacketSinkHelper sink ("ns3::UdpSocketFactory",
	...
	csma.EnableAsciiAll(ascii.CreateFileStream("L4Q1-1.tr"));
	csma.EnablePcapAll("L4Q1-1",false);
	std::string animFile = "L4Q1-1.xml";
